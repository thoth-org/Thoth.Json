...
tableOfContents:
  maxHeadingLevel: 3
slug: legacy/auto/json-representation
---

{/* Generated from json-representation.fsx. Do not edit — edit json-representation.fsx instead. */}
...
See [Manual API - JSON representation - Numbers](/Thoth.Json/legacy/manual/json-representation/#numbers) for more information.
