        ...
        [
            ...
            testList
                ...
                [
                    ...
                    <| fun _ ->
                        let expected = "\"maxime\""
                        let actual = Encode.string "maxime" |> Encode.toString 0
                        equal expected actual

                    testCase "a string with new line works"
                    <| fun _ ->
                        let expected = "\"a\\nb\""
                        let actual = Encode.string "a\nb" |> Encode.toString 4
                    ...
                    <| fun _ ->
                        let expected = "\"a\\tb\""
                        let actual = Encode.string "a\tb" |> Encode.toString 4
                    ...
                    <| fun _ ->
                        let expected = "\"a\""
                        let actual = Encode.char 'a' |> Encode.toString 0
                    ...
                    <| fun _ ->
                        let expected = "1"
                        let actual = Encode.int 1 |> Encode.toString 0
                        equal expected actual

                    testCase "a float works"
                    <| fun _ ->
                        let expected = "1.2"
                        let actual = Encode.float 1.2 |> Encode.toString 0
                        equal expected actual
                    ...
                    <| fun _ ->
                        let expected = "false"
                        let actual = Encode.bool false |> Encode.toString 0
                        equal expected actual

                    testCase "a null works"
                    <| fun _ ->
                        let expected = "null"
                        let actual = Encode.nil |> Encode.toString 0
                        equal expected actual

                    testCase "unit works"
                    <| fun _ ->
                        let expected = "null"
                        let actual = Encode.unit () |> Encode.toString 0
                        equal expected actual
                    ...
                    <| fun _ ->
                        let expected = "\"12\""
                        let actual = Encode.bigint 12I |> Encode.toString 0
                    ...
                    <| fun _ ->
                        ...
                        let actual =
                            0.7833M |> Encode.decimal |> Encode.toString 0
                    ...
                    <| fun _ ->
                        let expected = "99"
                        let actual = 99uy |> Encode.byte |> Encode.toString 0
                    ...
                    <| fun _ ->
                        let expected = "99"
                        let actual = 99y |> Encode.sbyte |> Encode.toString 0
                    ...
                    <| fun _ ->
                        let expected = "99"
                        let actual = 99s |> Encode.int16 |> Encode.toString 0
                    ...
                    <| fun _ ->
                        let expected = "99"
                        let actual = 99us |> Encode.uint16 |> Encode.toString 0
                    ...
                    <| fun _ ->
                        ...
                        let actual =
                            7923209L |> Encode.int64 |> Encode.toString 0
                    ...
                    <| fun _ ->
                        ...
                        let actual =
                            7923209UL |> Encode.uint64 |> Encode.toString 0
                    ...
                    <| fun _ ->
                        ...
                        let encoder =
                            Encode.Auto.generateEncoder<Record9> (extra = extra)

                        let actual = encoder value |> Encode.toString 0

                        let expected =
                            """{"a":5,"b":"bar","c":[[false,3],[true,5],[false,10]],"d":[["Foo",14],null],"e":{"ah":{"a":-1.5,"b":0},"oh":{"a":2,"b":2}},"f":"2018-11-28T11:10:29Z","g":[{"a":-1.5,"b":0},{"a":2,"b":2}],"h":"00:00:05","i":120,"j":120,"k":250,"l":250,"m":99,"n":"99","o":"999","r":[[{"a":-2.5,"b":22.1},"value 2"],[{"a":1,"b":2},"value 1"]],"s":"z"}"""
                    ...
                    <| fun _ ->
                        ...
                        let encoder1 =
                            Encode.Auto.generateEncoderCached<Record9> (
                                extra = extra
                            )
                    ...
                    testCase
                        "Encode.Auto.toString emit null field if setted for"
                    <| fun _ ->
                        let value =
                            {
                                fieldA = null
                    ...
                    testCase "Encode.Auto.toString works with bigint extra"
                    <| fun _ ->
                        ...
                        let actual =
                            Encode.Auto.toString (0, value, extra = extra)

                        equal expected actual

                    testCase "Encode.Auto.toString works with custom extra"
                    <| fun _ ->
                        let extra =
                            Extra.empty
                            |> Extra.withCustom
                    ...
                    testCase
                        "Encode.Auto.toString serializes maps with Guid keys as JSON objects"
                    <| fun _ ->
                        let m =
                            Map
                                [
                    ...
                    testCase
                        "Encode.Auto.toString works with records with private constructors"
                    <| fun _ ->
                    ...
                    testCase
                        "Encode.Auto.toString works with unions with private constructors"
                    <| fun _ ->
                    ...
                    testCase
                        "Encode.Auto.toString works with strange types if they are None"
                    <| fun _ ->
                        let expected = """{"Id":0}"""
                        ...
                        Encode.Auto.toString (0, value) |> equal expected

                    testCase
                        "Encode.Auto.toString works with interfaces if they are None"
                    <| fun _ ->
                        let expected = """{"Id":0}"""
                    ...
                    testCase "Encode.Auto.toString works with recursive types"
                    <| fun _ ->
                        let vater =
                            {
                                Name = "Alfonso"
                        ...
                        Encode.Auto.toString (0, vater) |> equal json
                    ...
                    <| fun _ ->
                        ...
                        let actual =
                            Encode.Auto.toString (0, Camera.FirstPerson)
                    ...
                    testCase "Encode.Auto.toString works with normal Enums"
                    <| fun _ ->
                        let expected = "2"
                        let actual = Encode.Auto.toString (0, Enum_Int.Two)
                        equal expected actual

                    testCase "Encode.Auto.toString works with System.DayOfWeek"
                    <| fun _ ->
                        let expected = "2"
                    ...
                    testCase
                        "Encode.Auto.toString generate `null` if skipNullField is true and the optional field value of type classes is None"
                    <| fun _ ->
                        let value =
                            {
                                MaybeClass = None
                    ...
                    testCase
                        "Encode.Auto.toString doesn't generate the optional field of type classe if it's value is None"
                    <| fun _ ->
                        let value =
                            {
                                MaybeClass = None
                        ...
                        let expected = """{"must":"must value"}"""
                        equal expected actual

                    testCase
                        "Encode.Auto.generateEncoder throws for field using a non optional class"
                    <| fun _ ->
                        let expected =
...
Documentation available at: https://thoth-org.github.io/Thoth.Json/documentation/auto/extra-coders.html#ready-to-use-extra-coders"""
                    ...
                    testCase
                        "Encode.Auto.toString(value, ...) is equivalent to Encode.Auto.toString(0, value, ...)"
                    <| fun _ ->
                        let expected =
                            Encode.Auto.toString (
                                0,
