...
let tests (runner : TestRunner<_, _>) =
    runner.testList "Thoth.Json.Encode" [

        runner.testList "Basic" [
            ...
            runner.testCase "an array works" <| fun _ ->
                let expected =
                    """["maxime",2]"""
                let actual =
                    Encode.array
            ...
            runner.testCase "a list works" <| fun _ ->
                let expected =
                    """["maxime",2]"""
                let actual =
                    Encode.list
            ...
            runner.testCase "a null works" <| fun _ ->
                let expected = "null"
                let actual =
                    Encode.nil
                    |> runner.Encode.toString 0
            ...
            runner.testCase "an object works" <| fun _ ->
                let expected =
            ...
            runner.testCase "a dict works" <| fun _ ->
                let expected =
                    """{"a":1,"b":2,"c":3}"""
                let actual =
                    Map.ofList
            ...
            runner.testCase "a map works" <| fun _ ->
                let expected =
                    """[["a",1],["b",2],["c",3]]"""
                let actual =
                    Map.ofList
            ...
            runner.testCase "a bigint works" <| fun _ ->
                let expected = "\"12\""
                let actual =
                    Encode.bigint 12I
                    |> runner.Encode.toString 0
            ...
            runner.testCase "a decimal works" <| fun _ ->
                let expected = "\"0.7833\""
                let actual =
                    0.7833M
                    |> Encode.decimal
            ...
            runner.testCase "a guid works" <| fun _ ->
            ...
            runner.testCase "an byte works" <| fun _ ->
                let expected = "99"
                let actual =
                    99uy
                    |> Encode.byte
            ...
            runner.testCase "an sbyte works" <| fun _ ->
                let expected = "99"
                let actual =
                    99y
                    |> Encode.sbyte
            ...
            runner.testCase "an int16 works" <| fun _ ->
                let expected = "99"
                let actual =
                    99s
                    |> Encode.int16
            ...
            runner.testCase "an uint16 works" <| fun _ ->
                let expected = "99"
                let actual =
                    99us
                    |> Encode.uint16
            ...
            runner.testCase "an int64 works" <| fun _ ->
            ...
            runner.testCase "an uint64 works" <| fun _ ->
                let expected = "\"7923209\""
                let actual =
                    7923209UL
                    |> Encode.uint64
            ...
            runner.testCase "an enum<sbyte> works" <| fun _ ->
                let expected = "99"
                let actual =
                    runner.Encode.toString 0 (Encode.Enum.sbyte Enum_Int8.NinetyNine)
            ...
            runner.testCase "an enum<byte> works" <| fun _ ->
                let expected = "99"
                let actual =
                    runner.Encode.toString 0 (Encode.Enum.byte Enum_UInt8.NinetyNine)
            ...
            runner.testCase "an enum<int> works" <| fun _ ->
                let expected = "1"
                let actual =
                    runner.Encode.toString 0 (Encode.Enum.int Enum_Int.One)
            ...
            runner.testCase "an enum<uint32> works" <| fun _ ->
                let expected = "99"
                let actual =
                    runner.Encode.toString 0 (Encode.Enum.uint32 Enum_UInt32.NinetyNine)
            ...
            runner.testCase "an enum<int16> works" <| fun _ ->
                let expected = "99"
                let actual =
                    runner.Encode.toString 0 (Encode.Enum.int16 Enum_Int16.NinetyNine)
            ...
            runner.testCase "an enum<uint16> works" <| fun _ ->
                let expected = "99"
                let actual =
                    runner.Encode.toString 0 (Encode.Enum.uint16 Enum_UInt16.NinetyNine)

                runner.equal expected actual

            runner.testCase "a tuple2 works" <| fun _ ->
            ...
            runner.testCase "a tuple3 works" <| fun _ ->
            ...
            runner.testCase "a tuple4 works" <| fun _ ->
            ...
            runner.testCase "a tuple6 works" <| fun _ ->
            ...
            runner.testCase "a tuple7 works" <| fun _ ->
            ...
            runner.testCase "a tuple8 works" <| fun _ ->
            ...
            runner.testCase "using pretty space works" <| fun _ ->
                let expected = "{\n    \"firstname\": \"maxime\",\n    \"age\": 25\n}"
            ...
            runner.testCase "complex structure works" <| fun _ ->
                let expected =
                    "{\n    \"firstname\": \"maxime\",\n    \"age\": 25,\n    \"address\": {\n        \"street\": \"main road\",\n        \"city\": \"Bordeaux\"\n    }\n}"
            ...
            runner.testCase "option with a value `Some ...` works" <| fun _ ->
            ...
            runner.testCase "option without a value `None` works" <| fun _ ->
